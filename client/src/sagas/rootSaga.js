...
import { changeMarkSaga, setOfferStatusSaga, addOfferSaga, getOffersSaga, setOfferStatusByModeratorSaga } from './offerSagas';
import {
  previewSaga,
  getDialog,
  sendMessage,
...
function* rootSaga() {
  ...
  yield takeLatest(ACTION.CLEAR_STORE, logoutSaga);
  ...
  yield takeEvery(ACTION.GET_OFFERS_FOR_MODERATOR_ACTION, getOffersSaga);
